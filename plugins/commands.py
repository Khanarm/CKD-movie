...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('【 Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ】', url="https://t.me/+K4n592296PI1YTg1"),
            InlineKeyboardButton('【 Dɪsᴄᴜssɪᴏɴ】', url='https://t.me/+K4n592296PI1YTg1')
        ],[
    ...
    if len(message.command) != 2:
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('Fʀɪᴇɴᴅsʜɪᴘ', url='https://t.me/zone_frnd_ak'),
            ...
            try:
                ...
                if STREAM_MODE == True:
                    button = [[
                        ...
                        InlineKeyboardButton('ᴏᴡɴᴇʀ', url="https://t.me/ak_arman_7")
                    ],[
                    ...
                    button = [[
                        ...
                        InlineKeyboardButton('ᴡᴏɴᴇʀ', url="https://t.me/ak_arman_7")
                    ]]
